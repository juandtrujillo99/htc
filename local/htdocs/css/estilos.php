...
.textoTitulo{font-size: 3em;letter-spacing: .05em;}
.textoTitulo1{font-size: 2.8em;letter-spacing: .01em;}
.textoSubtitulo{font-size: 2em;}
.textoSubtitulo1{font-size: 2em; margin-top: -1em;}
.textoSubtituloMarginIzq{font-size: 2em;margin-left: 1em;margin-top: -1em;}
.textoParrafo{font-size: 1.5em;line-height: 1em;}
.textoParrafo1{font-size: 1.2em;line-height: 1.2em;}
...
.btn-claro:hover, .btn-principal:active{color: <?php echo $colorMarca;?>;
...
.btn-principal-animado{transform: skew(-15deg);
...
.btn-principal-animado p{transform: skew(15deg);}
...
.btn-secundario-animado p{transform: skew(15deg);}
...
.copyright{background-color:<?php echo $colorMarca2;?>;padding: 1em 0;color: white;}
...
.social2-m a:hover,.social-m a:focus {color: <?php echo $colorMarca;?>;}


.planBg {background-color:#000; padding-bottom: 2em;}
...
.buyPlan{background-color: white;padding-top:1.5em;margin-left: 1em;margin-right: 1em;}
