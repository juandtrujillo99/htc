...
$basicPlan=RUTA_FORMULARIO_BASIC_ESP;
$standardPlan=RUTA_FORMULARIO_STANDARD_ESP;
$advancedPlan=RUTA_FORMULARIO_ADVANCED_ESP;
$proPlan=RUTA_FORMULARIO_PRO_ESP;
?>


<div class="row">
  <img style="margin-top: 4em;margin-bottom:.5em;" src="<?php echo RUTA_IMG;?>fondo/plan2.png" class="imagen">
  <div class="col-12">
    ...
    <div id="basic" class="col-12 planBg">
      <?php $planName="basic"; $cantidad="24.99"; $total="60.50"; ?>
      ...
      <div class="pricePlan">
        <?php include 'planPriceEu.inc.php';?>
      </div>  
    ...
    <div id="standard" class="col-12 planBg">
      <?php $planName="standard"; $cantidad="44.99"; $total="95.99"; ?>
      <div align="center" class="titlePlan">
        <p class="textoBlack white-text textoTitulo1"><?php echo $planName; ?> training</p>
        <p class="textoBold textoSubtitulo1 textoColorMarca1a">Plan</p>
      </div>
    ...
    <div id="pro" class="col-12 planBg">
      <?php $planName="pro"; $cantidad="134.99"; $total="204.99"; ?>
