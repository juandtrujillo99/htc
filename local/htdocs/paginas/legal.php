...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-10" style="margin-top: 4em;">
			<br><br>
			<h1 class="textoBlack">Términos y condiciones</h1>
			<p class="textoParrafo1">Última actualización: 05/03/2022</p>
			<br><br>
			<p class="textoParrafo"><b>DESCARGO DE RESPONSABILIDAD</b></p>
			<p class="textoParrafo1">
				<br>
				Los resultados pueden variar, Haroldtcoach no es nutricionista ni médico, no pretende sustituir el consejo profesional y no debe ser asumido como reflejo de un consejo profesional. El uso del programa Haroldtcoach (como cualquier otro programa de entrenamiento) tiene riesgo para su salud, seguridad y lesiones. Puedes consultar a tu médico o profesional de atención médica antes de seguir cualquier programa que recibas de Haroldtcoach. Queda totalmente bajo el riesgo del propio usuario por cualquier problema de salud que pueda sufrir y que pudiera resultar del programa.
				<br><br>
				Tu plan solo se congelará debido a embarazo si es de alto riesgo y tu médico lo autoriza, o lesión debidamente comprobada por medio de incapacidad médica durante el tiempo indicado textualmente en ella, es tu responsabilidad enviar la notificación por medio del chat de soporte para retomar el plan inmediatamente termine la incapacidad.
				<br><br>
				Si tienes cualquier duda por favor consulta antes de finalizar la compra. No hay proceso de reembolso.
				<br><br>
				<b>NOTA:</b> si tienes alguna discapacidad, patología o hábito alimenticio especial, debes consultar antes de hacer el pago, para confirmarte si puedes ser aceptado en el programa de entrenamiento. Todo esto con el fin de que estés totalmente satisfecho con el servicio adquirido.
				<br id="privacidad"><br><br>
			</p>	
			<p class="textoParrafo"><b>TRATAMIENTO DE DATOS PERSONALES</b></p>		
			<p class="textoParrafo1">
				<br>
				En Haroldtcoach implementaremos todas las acciones para el cumplimiento de la protección y tratamiento de datos personales de los que sea responsable, para proteger los derechos a la privacidad, intimidad y el buen nombre, además podemos actualizar y verificar los datos de los titulares que se encuentran en la base de datos, por esto hemos adoptado La Política de Tratamientos de Datos Personales, que serán expresadas en los siguientes términos:
				<br><br>
			...
			<p class="textoParrafo1">
				<br>
				Los siguientes son los aspectos generales que orientan la política de privacidad del sitio web www.haroldtcoach.com
				<br><br>
				...
				<br><br>
				<b>2.</b> El empleo de los mecanismos de aceptación, seguridad y acceso al sitio web que establezca haroldtcoach.
				<br><br>
			...
			<p class="textoParrafo1">
				<br>
				Al usar el sitio web www.haroldtcoach.com o al proporcionar información personal, nos estás autorizando a obtener, usar y divulgar tu información personal en la forma descrita en esta política.
				<br><br><br>				
			</p>
			<p class="textoParrafo"><b>SEGURIDAD DE INFORMACIÓN PERSONAL</b></p>
			<p class="textoParrafo1">
				<br>
				Tu información personal será almacenada en las bases de datos de haroldtcoach, en la cual mantenemos protecciones razonables para garantizar la confidencialidad, seguridad e integridad de tu información personal.
				<br><br>
				...
				<br><br>
				En Haroldtcoach sabemos que ninguna transmisión de información a través de Internet es absolutamente segura y confidencial; igualmente, se implementarán todas las herramientas de seguridad razonables aceptadas por la industria.
				<br><br><br>				
			</p>
			<p class="textoParrafo"><b>DERECHO DE ACCESO Y CORRECCIÓN</b></p>
			<p class="textoParrafo1">
				<br>
				Tienes el derecho a revisar y modificar cualquier información personal almacenada en nuestro sistema y bases de datos. Si consideras que esta información está desactualizada o es incorrecta, puedes comunicarte con nosotros a través del correo electrónico haroldtcoach@gmail.com.
				<br><br><br>				
			</p>
			<p class="textoParrafo"><b>DERECHO DE CANCELACIÓN</b></p>
			<p class="textoParrafo1">
				<br>
				Tienes el derecho, en cualquier momento, de retirar tu información personal en el futuro. En dicho caso, puedes comunicarte con nosotros a través del correo electrónico haroldtcoach@gmail.com
				<br id="cookies"><br><br>				
			</p>
			...
			<p class="textoParrafo1">
				<br>
				Los siguientes son los lineamientos de nuestra política de privacidad en cuanto al recaudo, acceso y uso de la información de registro que suministra el usuario a través del sitio web www.haroldtcoach.com
				<br><br>
				• Los datos o información personal o general que Haroldtcoach recolecta de los usuarios en su sitio web, se utilizarán exclusivamente para cumplir con los propósitos del sitio web y su uso es el establecido de acuerdo a la política de privacidad.
				<br><br>
				• El usuario del sitio web, con la aceptación de esta política de privacidad, autoriza a Haroldtcoach a realizar un tratamiento autorizado a todos los datos personales y generales suministrados a través del sitio web.
				<br><br>
				...
				<br><br>
				• El usuario del sitio autoriza a Haroldtcoach a tratar de forma automatizada la información solicitada con el fin de ofrecer un servicio más eficiente y personalizado. Así mismo, el usuario autoriza a Haroldtcoach a divulgar, ceder o transferir sus datos personales y la información suministrada a otras organizaciones vinculadas o asociadas con haroldtcoach.
				<br><br>
				• La información suministrada por los usuarios en ningún caso se compartirá con terceros, exceptuando organizaciones vinculadas con haroldtcoach.
				<br><br>
				• Haroldtcoach podrá realizar en cualquier momento encuestas para evaluar el tráfico del sitio y la calidad percibida.
				<br><br><br>				
			</p>
			...
			<p class="textoParrafo1">
				...
				<br><br>
				• El usuario está de acuerdo en proporcionar a Haroldtcoach información verdadera y completa acerca de sí mismo. Adicionalmente, el usuario se compromete en mantener actualizada esta información.
				<br><br>
				• Haroldtcoach se reserva el derecho a retirar sin previa notificación al usuario si la información se considera nociva o perjudicial.
				<br><br>
				• Haroldtcoach no se hace responsable por el uso que los terceros puedan hacer con la información indebidamente asegurada y protegida por el usuario
				<br><br>
				• El usuario no recaudará ni divulgará, los datos personales o la información de los demás usuarios del sitio web de haroldtcoach.
				<br><br>
				• El suministro de información falsa o la omisión de cualquier obligación, le da el derecho a Haroldtcoach a terminar automáticamente, sin previo aviso y de forma definitiva, la provisión de servicios al usuario.
				<br><br><br>				
			</p>
			...
			<p class="textoParrafo1">
				<br>
				Todas las inquietudes y dudas te las responderé a través de correo electrónico, telegram o whatsapp en un período máximo de 48 horas (Lunes a Viernes). Para gestiones de quejas, peticiones y reclamos o para ejercer tus derechos, podrás comunicarte al correo electrónico haroldtcoach@gmail.com
				<br><br>
				En Haroldtcoach daremos respuesta a la persona que haga la petición, queja o reclamo dentro de los términos establecidos por la Ley 1581 de 2012, la solicitud debe contener todos los datos necesarios garantizando así una respuesta oportuna y efectiva. La solicitud para ser tramitada, debe ser presentada por el titular de los datos, o en su defecto por el representante legal; por lo tanto tenemos el derecho a verificar la identidad de la persona que realice la queja, petición o reclamo. Independientemente del mecanismo utilizado para la radicación de quejas, peticiones y reclamos, serán atendidas en un término máximo de quince días hábiles contados a partir de la fecha de su recibo. Si por algún motivo no es posible atender la consulta dentro de dicho término, se informará a la persona antes de su vencimiento, expresando los motivos de la demora y señalando la fecha en que se hará y atenderá la consulta, la cual no podrá superar los cinco días hábiles siguientes al vencimiento del primer plazo.
				<br><br>
			...
			<p class="textoParrafo1">
				<br>
				La entrega de los productos está establecida por la compañía de transporte Envía, Servientrega o Interrapidisimo para ser entregado de lunes a viernes en horarios de 8:00 am a 6:00 Pm y sábados de 8:00 am a 1:00 Pm. Solo se harán entregas en territorio Colombiano.
				<br><br>
				El tiempo de entrega de los productos es aproximadamente de 1 a 3 días hábiles para la ciudad de Cali, de 2 a 5 días hábiles para ciudades principales y de 3 a 5 días hábiles para otros destinos. En caso de NO encontrar el destinatario el paquete entrará a proceso de reexpedición y podrá tomar hasta 3 días hábiles adicionales.
				<br><br>
				Los pedidos serán enviados únicamente en días hábiles los cuales se catalogan de Lunes a Viernes, excluyendo los sábados, domingo y festivos nacionales de Colombia.
				<br><br>
