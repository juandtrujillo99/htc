...
class EscritorEntradasTienda {
		...
		<a href="<?php echo RUTA_ENTRADA_TIENDA . '/' . $entrada -> obtener_url() ?>" class="col-6 col-md-3" style="padding:.5em">
			<div class="row card" style="background-color: white;color: black;box-shadow: none;border: 0;">
				...
				<div class="card-content" style="padding:.2em 0;">
					<p class="textoBookBold textoParrafo"><?php echo EscritorEntradasTienda::resumir_titulo(nl2br($entrada -> obtener_titulo())); ?></p>
					<p class="textoBookBold">$<?php echo $entrada -> obtener_precio(); ?> (COP)</p>
				</div>         
			</div>
		</a>
		<?php
	...
	public static function escribir_preview_entradas($entrada) {
		...
		?>
		<a href="<?php echo RUTA_ENTRADA_TIENDA . '/' . $entrada -> obtener_url() ?>" class="col-12 col-md-3" style="padding:.5em;">
			<div class="row card" style="background-color: white;color: black;box-shadow: none;border: 0;">
				<div class="card-image">                    
					<div align="center">   
						<div class="img-entrada bg-cover" style="background-image:url(<?php echo RUTA_TIENDA_COVER. $entrada -> obtener_imagen(); ?>);"></div>
		...
		<a href="<?php echo RUTA_ENTRADA_TIENDA . '/' . $entrada -> obtener_url() ?>" class="col-6 col-md-3" style="padding:.5em">
			<div class="row card" style="margin: .5em;">
				<div class="card-image">                    
					...
					<span class="card-title textoBookBold textoParrafo filtroEntrada truncate"><?php echo EscritorEntradasTienda::resumir_titulo(nl2br($entrada -> obtener_titulo())); ?></span>
				</div>          
			</div>
		</a>
		<?php
