...
<div class="col-12 row">
  ...
  <div align="center" class="col-2">
    <!-- Dropdown Trigger -->
    <a class='dropdown-trigger btn-floating white btn-large pulse' href='#' data-target='drop<?php echo $planName; ?>'><img src="<?php echo RUTA_IMG;?>bandera/co.png" class="imagen-2"></a>
    <!-- Dropdown Structure -->
