<div class="row">
    ...
    <div align="center" class="col-10 col-md-12 bg-image" style="background-image: url(<?php echo RUTA_IMG_OPTIMIZADA;?>fondo/profile-cover.webp);border-radius: 0px 0px 1em 1em;">
        <div class="valign-wrapper row">
            <div class="d-none d-sm-block" style="height: 50vh;"></div>
            <div class="d-block d-sm-none" style="height: 30vh;"></div>
            <div align="center" class="col-12">
                <p class="textoBlack textoTitulo1a white-text" style="font-size: 2.5em;">Hola <?php echo $admin -> obtener_nombre(); ?>, Eres administrador </p>
            </div>            
        </div>
    </div>  
    <div class="col-1 d-block d-sm-none"></div>
