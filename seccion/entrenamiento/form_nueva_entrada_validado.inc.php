<div class="col-12">
	<div class="input-field">
		...
		<label for="titulo">Nombre del ejercicio</label>
	</div>
	<br>
	<div class="input-field">
				...
				<div class="collapsible-body">
					<span>
						<div class="form-group" id="upload_form">
							<?php
							$rutaFoto = RUTA_RUTINA_EJERCICIOS_COVER.$validador -> obtener_imagen();
							...
							<?php
								...
								<img src="<?php echo RUTA_RUTINA_EJERCICIOS_COVER.$validador -> obtener_imagen();?>" class="imagen-3">
								<br><br>
								<h4>Cambiar foto</h4>
								<label for="file1" id="label-archivo" class="btn btn-principal" >Seleccionar</label>
								<input type="file" name="file1" id="file1" class="d-none">
	...
	<br>
	<div class="input-field">
		<input type="text" name="url_externa" id="url_externa" class="validate"<?php $validador -> mostrar_url_externa(); ?> >
		<?php $validador -> mostrar_error_url_externa(); ?>
		<label for="url_externa">Código del video</label>
	</div>
	<br>
	<div class="input-field">
		<textarea id="texto" name="texto" class="materialize-textarea" data-length="120"><?php $validador -> mostrar_texto(); ?></textarea>
		<?php $validador -> mostrar_error_texto(); ?>
		<label for="texto">Descripción detallada del ejercicio</label>
    </div> 
	<br>   
	<div class="input-field">
		...
		<label for="etiqueta">Etiqueta el grupo muscular</label>
	</div>
</div>