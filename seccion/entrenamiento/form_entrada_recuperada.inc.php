				...
				<div class="collapsible-body">
					<span>
						<div class="form-group" id="upload_form">
							<?php
							$rutaFoto = RUTA_RUTINA_EJERCICIOS_COVER.$entrada_recuperada -> obtener_imagen();
							...
							<?php
								...
								<img src="<?php echo RUTA_RUTINA_EJERCICIOS_COVER.$entrada_recuperada -> obtener_imagen();?>" class="imagen-3">	
