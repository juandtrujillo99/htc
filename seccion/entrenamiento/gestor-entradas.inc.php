<div class="row">
	...
	<div class="col-10" style="padding: 6em 0 1.5em 0;">
		...
		<br>
		<a href="<?php echo RUTA_NUEVA_ENTRADA_ENTRENAMIENTO; ?>" class="btn btn-secundario-animado" role="button" id="boton-nueva-entrada">Crear entrada</a>
		<br>
		<br>
	</div>
	<div class="col-1"></div>
						...
						<tbody>
							...
							for ($i = 0; $i < count($array_entradas); $i++) {
								...
								<tr>										
									...
									<td><a target="_blank" href="<?php echo RUTA_ENTRADA_ENTRENAMIENTO . '/' . $entrada_actual -> obtener_url(); ?>"><?php echo $entrada_actual -> obtener_titulo(); ?></a></td>									
									...
									<td>
										<form method="post" action="<?php echo RUTA_BORRAR_ENTRADA_ENTRENAMIENTO; ?>">
