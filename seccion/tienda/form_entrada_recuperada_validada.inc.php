...
<div class="col-12">
	...
	<div class="col-12">
		<ul class="collapsible">
		    <li>
				<div class="collapsible-header" title="Con esta fotografía las personas podran identificar fácilmente el producto">Cambiar foto<?php $validador -> mostrar_error_imagen();?></div>
	...
	<br><br>
	<div class="input-field">
		<input placeholder="Pega aquí el código" type="text" name="url_externa" id="url_externa" class="validate" value="<?php echo $entrada_recuperada -> obtener_url_externa(); ?>">
