<div class="col-12">
	...
	<div class="col-12">
		<ul class="collapsible">
		    <li>
				<div class="collapsible-header" title="Con esta fotografía las personas podran identificar fácilmente el producto">Sube una imagen de portada <?php $validador -> mostrar_error_imagen(); ?></div>
	...
	<br><br>
	<div class="input-field">
		<input placeholder="Código del audio" type="text" name="url_externa" id="url_externa" class="validate"<?php $validador -> mostrar_url_externa(); ?> >
		<?php $validador -> mostrar_error_url_externa(); ?>
		<label for="url_externa">Inserta el código</label>
	</div>
	<br>
	<div class="input-field">
		<input placeholder="Ponle precio a este producto" type="text" name="precio" id="precio" <?php $validador -> mostrar_precio(); ?> >
