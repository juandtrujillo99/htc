...
.barra-navegacion-pc{z-index:99;position: fixed;width: 100%;border-bottom: 3px solid <?php echo $colorMarca;?>;}
...
.menu-burger-pc:after,
.menu-burger-pc:before,
.menu-burger-pc{
    background-color: <?php echo $colorMarca;?>;/*Color de las barras del menu*/
    content: '';
    transition: .5s;
...
.menu-burger-pc:before{/* palito de abajo */
    top: 50px;
    height: 100%;
}

.menu-burger-pc:after{/* palito de arriba */
    height: 100%;
    top: -50px;
}
...
.menu-pc>a>div:hover,.menu>a>div:focus{/*controla el efecto al pulsar un enlace en el menu*/
    color: <?php echo $colorMarca4;?>;
    font-family: <?php echo $textoBold;?>;
}
...
.menu-pc>a>div>i{/*si quieres agregar iconos al lado de los enlaces, con esto lo controlas*/
    font-size: .7em;
}
