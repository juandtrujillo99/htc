...
.textoBlack{font-family: <?php echo $textoBlack;?>;text-transform: uppercase;letter-spacing: .035em;font-style: italic;}
.textoBold{font-family: <?php echo $textoBold;?>;letter-spacing: .05em;}
.textoBookBold{font-family: <?php echo $textoBookBold;?>;font-style: italic;text-transform: uppercase;}
...
.textoTitulo{font-size: 3em;letter-spacing: .05em;line-height: 1em;}
.textoTitulo1{font-size: 2.8em;letter-spacing: .01em;line-height: 1em;}
.textoTitulo1a{text-transform: uppercase;letter-spacing: -.01em;line-height: 1em;}
...
.dev{background-color:<?php echo $colorMarca4;?>;padding: 1.5em 1em 2em 1em;}
