<div class="d-none d-sm-block">
	<div class="col-12 row" style="margin-top: 10vh">	
		...
		<div class="col-7 row">
			...
			<div class="col-8 row">
				<div class="col-12">
					<h1 style="font-size: 4em;line-height: 1.1em;" class="textoBlack">Premium Pack para redes sociales</h1>
				...
				<div class="col-12 row">
					...
					<div class=" col-3">
						<a class="btn btn-descuento" style="font-size: .8em;">45% off</a>
					</div>
				</div>
...
<div class="d-block d-sm-none">
	<div class="col-12 row">
		<div class="col-12">
			...
			<img loading="lazy" src="<?php echo RUTA_IMG;?>pack/premium.webp" class="imagen">
		</div>
		<div class="col-1"></div>
		<div class="col-10 row">
			<div class="col-12"><h2 style="font-size: 3em;line-height: 1.1em;" class="textoBlack">Premium Pack para redes sociales</h2></div>
			<div class="col-12"><h6 style="font-size: 1.5em;padding-top: 1em;" class="textoBlack">€49.99 / Mes</h6></div>
			<div class="col-12 row">
				<div class=" col-3">
					<h6 style="font-size: 1.5em;text-decoration: line-through;" class="textoBlack grey-text">€89.99 </h6>
				</div>
