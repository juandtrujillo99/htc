<?php
    ...
    /* las lineas estan corridas 17 casillas, es decir, si te dicen linea 10 en realidad se refiere a la linea 27*/
?>
/*estilos para pc*/
...
.btn-principal{box-shadow: inset 0px 0px 0px 4px #0d0d0d;line-height: 1.5em;padding: 0.4em 2em;text-transform: uppercase; font-family:<?php echo $texto2Black?>;}
...
.btn-principal-animado{
  box-shadow: inset 0px 0px 0px 4px #0d0d0d;line-height: 1.5em;padding: 0.4em 2em; text-transform: uppercase; font-family:<?php echo $texto2Black?>;
  color: #0d0d0d;
  background-image: transparent 50%;  
  background-size: 200%;
  background-position: 0% 50%;
  transition: .3s;
  border-radius: 0;}
.btn-principal-animado:hover, .btn-principal-animado:active{color: #fff;
  background-position: 100% 50%;transition: .4s;
background-image: linear-gradient(to right, transparent 50%, <?php echo $colorMarca;?> 50%, <?php echo $colorMarca;?> 100%);}
...
.service1 .bordeadoNegro div, .service1 .bordeadoNegro2 div{padding: 2em}
...
.side-nav {
  ...
  font-family: <?php echo $textoBlack; ?>; text-transform: uppercase;
}
...
.side-nav .enlaces .redes a {font-size: 1.9em;text-decoration: none;color: #fff;}
.side-nav .enlaces .redes a:hover {font-size: 1.9em;text-decoration: none;color: #fff;transition: 1s;}
.side-nav .enlaces a {font-size: 1.9em;text-decoration: none;color: #fff;letter-spacing: .05em;transition: 1s;padding-left: .2em;}
.side-nav .enlaces a:hover {color:<?php echo $colorMarca;?>;border-left: .1em solid <?php echo $colorMarca;?>;padding-left: 1em;transition: 1s;}
