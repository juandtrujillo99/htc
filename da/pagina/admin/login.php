	...
	<div class="row section">
	    ...
	    <div class="col-12 col-md-5 center-align valign-wrapper" style="box-shadow: 0px .1px 5px 0px rgba(0,0,0,0.1);">
	    	...
	    	<div class="col-md-8 col-12">
	    		<img  loading="lazy" itemprop="image" class="imagen-2" src="<?php echo RUTA_IMG;?>logo/1.png">
	    	</div>
	    </div>
	    		...
	    		<form role="form" method="post" class="col-sm-12" action="<?php echo RUTA_LOGIN_ADMIN; ?>">
					...
					<div class="row">
						<div class="col-10 input-field">
							<input type="password" name="clave" id="txtPassword">
							<label for="clave">Contraseña</label>
						</div>
						<div class="col-2">
							<button class="btn btn-sombra" id="show_password" type="button" onclick="mostrarPassword()"><span class="fa fa-eye-slash icon"></span></button>
							<?php
							if(isset($_POST['login'])){
