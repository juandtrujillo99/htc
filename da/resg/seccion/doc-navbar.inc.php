<div id="slide-out" class="row side-nav"> 
  <div class="col-12 row enlaces">
    ...
    <div class="col-10" align="left">
      <img class="logo" itemprop="image" alt="logo DareAds" src="<?php echo RUTA_IMG; ?>logo/3.png">
      <div class="d-none d-sm-block">
        <br><br>
        <a href="<?php echo SERVIDOR;?>#inicio">Inicio</a>
        <br>
        ...
        <a href="<?php echo SERVIDOR;?>#about">Nosotros</a>
        <br>
        <a href="<?php echo SERVIDOR;?>#contacto">Contacto</a>
        <br><br><br>
        <p style="color: white;font-size: 1.2em;letter-spacing: .05em;">Síguenos</p>
        <div class="col-12 row redes">
          ...
          <a class="col-2" href="<?php echo $whatsappEmpresa;?>" target="_blank"><i class="fab fa-whatsapp"></i></a>
        </div>
      </div>
      <div class=" d-block d-sm-none">
        ...
        <a href="<?php echo RUTA_ABOUT;?>">Nosotros</a>
        <br>
