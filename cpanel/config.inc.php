...
define('NOMBRE_SERVIDOR', 'host43.latinoamericahosting.com'); //se deja así
define('NOMBRE_USUARIO', 'haroldtc'); //nombre de usuario de la base de datos
define('PASSWORD', '31Mg!Kva39Wi:C');
define('NOMBRE_BD', 'haroldtc_db1');//Nombre de la Base de datos
...
//Pestañas principales (basicas o  comunes) de la web
	...
	*/
	define("SERVIDOR", "https://haroldtcoach.com");//carpeta raiz (la que contiene todos los archivos para el funcionamiento de la página)
