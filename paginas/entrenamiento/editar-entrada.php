...
include_once 'app/entrenamiento/ValidadorEntradaEditada.inc.php';
...
$titulo = "Editar entrada de ejercicios";
...
<div class="container" style="margin-bottom: 3em;">
	<div class="row valign-wrapper">
		...
		<div class="col-12 row">
			<div class="col-1"></div>
			<div class="col-10">
				<form method="post" action="<?php echo RUTA_EDITAR_ENTRADA_ENTRENAMIENTO ?>">
				<?php
					if (isset($_POST['editar_entrada'])) {
						...
						include_once 'seccion/entrenamiento/form_entrada_recuperada.inc.php';
						...
						include_once 'seccion/entrenamiento/form_entrada_recuperada_validada.inc.php';
					}
				?>
				<br>
