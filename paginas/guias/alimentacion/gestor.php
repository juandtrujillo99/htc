      ...
      <div class="row">
		...
		<div class="col-12 d-block d-sm-none" style="background-color: white;z-index: 99;position:fixed;bottom: 0;">   
			<div style="padding: 2em;">    
				<form method="post" enctype="multipart/form-data" class="row col-12" style="padding-bottom:2em;">					
					<div class="col-8">		
						<div class="input-field">
							<input name="email" placeholder="Correo electrónico del usuario" required>
						</div>
					...
					<div class="col-3">
						<input hidden type="file" name="formato" id="formato">
						<input style="width: 100%;padding: 1em 0;" class="btn btn-secundario-animado" type="submit" name="subir" value="cargar">
					</div>					         
				</form>
				<form method="post" class="row col-12">
						<div class="col-8 row input-field">
							<input name="borrarFor" placeholder="nombre.pdf" required>
						</div>
						<div class="col-1"></div>
						<div class="col-3">
							<input style="width: 100%;padding: 1em 0;" class="btn btn-secundario-animado" type="submit" name="borrar" value="Eliminar">
						</div>              
						<div>
							<?php echo $mensajeOk;?>
						</div>				           
