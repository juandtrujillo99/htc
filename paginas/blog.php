...
<div class="container">
	...
	<div class="row" style="padding: 4em 0 2.5em 0;" align="center">
	    ...
	    <div class="col-10 col-md-4">
	        <br><br>     
	        <p class="textoBlack textoTitulo1" style="font-size: 3em;">Newsletter</p>       
	    </div>    
	    <div class="col-1 col-md-4"></div>	        
	    <div class="col-1"></div>
        <div class="col-10">
            ...
            <p class="textoBookBold textoParrafo">
            	En esta sección encontrarás toda la información que te ayudará en tu día a día para adquirir hábitos saludables.
            </p>
        </div>  
        <div class="col-1"></div>
